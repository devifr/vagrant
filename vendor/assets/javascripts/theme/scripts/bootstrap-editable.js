        ...
        render: function() {
            ...
            **/            
            ...
            .then($.proxy(function () {
                ...
                console.log(this.$form.find('.editable-delete'))
                this.$form.find('.editable-delete').attr('href', this.$form.parents('.popover').parent().find('.editable-open').attr('data-url'));
...
(function ($) {
  "use strict";
    ...
    //buttons
    $.fn.editableform.buttons = '<button type="submit" class="btn btn-info btn-small editable-submit"><i class="icon-ok icon-white"></i></button>'+
    '<a href class="btn btn-small btn-danger editable-delete" data-confirm="Are You Sure?" data-method="delete" rel="nofollow"><i class="icon-trash"></i></a>';         
        ...
        setPosition: function () { 
          ...
          (function() {    
            ...
            $tip
              ...
              if(Number($tip.css('left').replace('px','')) < 0){
                $tip.css('left', '0px');
              }
